...
// Enhanced sample notifications for supermarket
const sampleNotificationsData = [
  {
    id: 1,
    type: 'success',
    title: 'Order Accepted',
    message: 'Silva Farms has accepted your order ORD-2026-001 for 500kg Tomatoes.',
    time: '1 hour ago',
    isRead: false,
  ...
  },
  {
    ...
    message: 'You received a quote from Fernando Farms for your Rice request.',
    time: '3 hours ago',
    isRead: false,
  ...
  },
  {
    ...
    message: 'Order ORD-2026-001 will be delivered tomorrow at 8:00 AM.',
    time: '5 hours ago',
    isRead: true,
    orderNumber: 'ORD-2026-001',
    createdAt: new Date('2026-02-02T07:00:00'),
  },
  {
    id: 4,
    type: 'success',
    title: 'Delivery Completed',
    message: 'Order ORD-2026-002 for 300kg Onions has been delivered successfully.',
    time: '1 day ago',
    isRead: true,
  ...
  },
  {
    ...
    message: 'Payment due for order ORD-2026-003 (Rs. 125,000) - Due in 2 days.',
    time: '1 day ago',
    isRead: false,
  ...
  },
  {
    ...
    message: 'Kumar Farms could not fulfill your order ORD-2026-004 for Carrots.',
    time: '2 days ago',
    isRead: true,
  ...
  },
  {
    ...
    message: 'Fresh organic vegetables now available from Silva Farms in Nuwara Eliya.',
    time: '2 days ago',
    isRead: false,
    createdAt: new Date('2026-01-31T08:00:00'),
  },
  {
    id: 8,
    type: 'info',
    title: 'Price Update',
    message: 'Tomato prices have decreased by 10% in your preferred locations.',
    time: '3 days ago',
    isRead: true,
            ...
            <View style={styles.modalBody}>
              ...
              {notification.orderNumber && (
                  <View style={styles.orderInfoCard}>
                    <Ionicons name="document-text-outline" size={20} color={COLORS.supermarket.primary} />
              ...
              <View style={styles.modalActions}>
                ...
                {notification.orderNumber && (
                    ...
                    >
                      <Ionicons name="eye-outline" size={20} color={COLORS.supermarket.primary} />
                      <Text style={[styles.modalButtonText, { color: COLORS.supermarket.primary }]}>
                        See Order Details
                      </Text>
                    </TouchableOpacity>
                )}
...
const SupermarketNotificationsScreen = ({ navigation }) => {
  ...
  const handleViewOrder = (orderNumber) => {
    ...
    if (navigation) {
      navigation.navigate('SupermarketOrders', {
          ...
          {isSelecting ? (
              ...
              <>
                ...
                {unreadCount > 0 && (
                    ...
                    >
                      <Ionicons name="checkmark-done-outline" size={20} color={COLORS.supermarket.primary} />
                    </TouchableOpacity>
                )}
              </>
          )}
...
const styles = StyleSheet.create({
  ...
  unreadCard: {
    backgroundColor: COLORS.supermarket.primary + '05',
  },
  selectedCard: {
